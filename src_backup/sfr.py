...
class Corrections:
    ...
    mass function (PowerLawIMF), or simply Kroupa SFR, is assumed, for the environment-dependent galactic PowerLawIMF (gIMF) obtained in
    the integrated galaxy-wide PowerLawIMF (IGIMF) framework. The corrections are a multiplicative factor dependent on the
    ...
    References
    ----------
    .. [1] Chruslinska, M., Jerabkova, T., Nelemans, G., Yan, Z. (2020). The effect of the environment-dependent PowerLawIMF on
...
class ChruslinskaSFRD:
    ...
    metallicities. These grids already take into account the corrections for environment-dependent PowerLawIMF treated in the
    Corrections class.
