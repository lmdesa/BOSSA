...
class RandomSampling:
    ...
    def __init__(self, imf, discretization_points=20):
        ...
        discretization_points : int
            Number of mass values per mass decade on which the IMF will be computed for interpolation.
        """
...
class OptimalSampling:
    ...
    def _integrate_imf(self, m1, m2):
        """Analitically compute the integral of the IMF from m1_table to m2.

        Analitically computes the integral of the IMF from m1_table to m2 for a simple power law, or a multi power law if
