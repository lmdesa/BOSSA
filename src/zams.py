...
class ZAMSSystemGenerator:
    ...
    initial mass function (IMF) that the sample should reproduce.
    ...
    Salpeter IMF [1]_. Each Group is structure in 100 Tables, each corresponding to one of 100 equiprobable logp values
